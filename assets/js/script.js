(function($) {
	...
	// rellaxInit removed to prevent error if Rellax library is not loaded
	...
	function headerStyle() {
		if($('.main-header').length || $('.header-v2').length){
			var windowpos = $(window).scrollTop();
			var siteHeader = $('.main-header, .header-v2');
			var scrollLink = $('.scroll-to-top');
			if (windowpos > 50) {
				siteHeader.addClass('scrolled fixed-header animated slideInDown');
				scrollLink.fadeIn(300);
			} else{
				siteHeader.removeClass('scrolled fixed-header animated slideInDown');
	...
	$(document).on('click', '.mobile-menu-v2 .nav-link-v2', function() {
		$('.header-v2').removeClass('mobile-open');
	});
